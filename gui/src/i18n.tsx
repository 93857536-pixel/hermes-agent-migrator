...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "settings.server_url": "Cloud server URL",
    "settings.server_url_hint": "e.g. https://linminhao.top/hermes-cloud — leave empty for the local backend",
    "settings.save_server": "Save server",
    "settings.clear_server": "Use local backend",
    "cloud.backend_local": "Local backend",
    "cloud.backend_remote": "Remote backend",
  ...
  zh: {
    ...
    "settings.account": "账户",
    "settings.device": "设备",
    "settings.server_url": "云端服务器地址",
    "settings.server_url_hint": "例如 https://linminhao.top/hermes-cloud — 留空使用本地后端",
    "settings.save_server": "保存服务器",
    "settings.clear_server": "改用本地后端",
    "cloud.backend_local": "本地后端",
    "cloud.backend_remote": "远端后端",
    "cloud.backend": "后端",
    "settings.storage": "存储",
  ...
  "zh-TW": {
    ...
    "settings.account": "帳戶",
    "settings.device": "裝置",
    "settings.server_url": "雲端伺服器地址",
    "settings.server_url_hint": "例如 https://linminhao.top/hermes-cloud — 留空使用本機後端",
    "settings.save_server": "儲存伺服器",
    "settings.clear_server": "改用本機後端",
    "cloud.backend_local": "本機後端",
    "cloud.backend_remote": "遠端後端",
    "cloud.backend": "後端",
    "settings.storage": "儲存",
